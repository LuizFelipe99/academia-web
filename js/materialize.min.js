...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, Materialize.Vel = Vel || Velocity,
    function (t) {
        t.fn.collapsible = function (e, i) {
            ...
            return e = t.extend(n, e), this.each(function () {
                function n(e) {
                    p = d.find("> li > .collapsible-header"), e.hasClass("active") ? e.parent().addClass("") : e.parent().removeClass("active"), e.parent().hasClass("active") ? e.siblings(".collapsible-body").stop(!0, !1).slideDown({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1,
                        complete: function () {
                ...
                function a(e) {
                    e.hasClass("active") ? e.parent().addClass("") : e.parent().removeClass("active"), e.parent().hasClass("active") ? e.siblings(".collapsible-body").stop(!0, !1).slideDown({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1,
                        complete: function () {
    ...
    function (t) {
        t.fn.scrollTo = function (e) {
            ...
            return "open" === e ? (this.each(function () {
                ...
                function o(e) {
                    "focus" === e && (l = !0), n(), c.addClass(""), r.addClass("");
        ...
        var e = {
            init: function (e) {
                ...
                return this.each(function (i) {
                    ...
                    e.swipeable && d > e.responsiveThreshold && (e.swipeable = !1), 0 === (o = t(p.filter('[href="' + location.hash + '"]'))).length && (o = t(this).find("li.tab a.active").first()), 0 === o.length && (o = t(this).find("li.tab a").first()), o.addClass(""), (m = p.index(o)) < 0 && (m = 0), void 0 !== o[0] && (a = t(o[0].hash)).addClass(""), u.find(".indicator").length || u.append('<li class=""></li>'), s = u.find(""), u.append(s), u.is(":visible") && setTimeout(function () {
                        s.css({
                            right: b(o)
                        }), s.css({
                            left: w(o)
                        ...
                        onCycleTo: function (t) {
                            if (!y) {
                                var i = m;
                                m = r.index(t), o.removeClass("active"), (o = p.eq(m)).addClass(""), k(i), "function" == typeof e.onShow && e.onShow.call(u[0], a)
                            }
                        }
                        ...
                        if (t(this).parent().hasClass("disabled")) i.preventDefault();
                            ...
                            o.position();
                            o.addClass(""), g = m, (m = p.index(t(this))) < 0 && (m = 0), e.swipeable ? f.length && f.carousel("set", m, function () {
                                "function" == typeof e.onShow && e.onShow.call(u[0], a)
                            }) : (void 0 !== a && (a.show(), a.addClass(""), "function" == typeof e.onShow && e.onShow.call(this, a)), void 0 === n || n.is(a) || (n.hide(), n.removeClass("active"))), l = setTimeout(function () {
                                y = !1
        ...
        t(document).ready(function () {
            ...
            Materialize.updateTextFields = function () {
                t("input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], textarea").each(function (e, i) {
                    var n = t(this);
                    t(i).val().length > 0 || t(i).is(":focus") || i.autofocus || void 0 !== n.attr("placeholder") ? n.siblings("label").addClass("") : t(i)[0].validity ? n.siblings("label").toggleClass("active", !0 === t(i)[0].validity.badInput) : n.siblings("label").removeClass("active")
                })
            };
            ...
            t(document).on("change", i, function () {
                0 === t(this).val().length && void 0 === t(this).attr("placeholder") || t(this).siblings("label").addClass(""), validate_field(t(this))
            }), t(document).ready(function () {
                ...
                t(this).siblings("label, .prefix").addClass("")
            ...
            t(document).on("change", o, function (e) {
                ...
                var n = s(t(this));
                i.addClass("").css("left", n)
            }), t(document).on("mousedown touchstart", o, function (e) {
                var i = t(this).siblings(".thumb");
                if (i.length <= 0 && (i = t('<span class="thumb"><span class="value"></span></span>'), t(this).after(i)), i.find(".value").html(t(this).val()), a = !0, t(this).addClass(""), i.hasClass("active") || r(i), "input" !== e.type) {
                    var n = s(t(this));
                    i.addClass("").css("left", n)
                }
                ...
                if (a) {
                    ...
                    var l = s(n);
                    i.addClass("").css("left", l), i.find(".value").html(i.siblings(o).val())
                }
                ...
                return e = t.extend(i, e), this.each(function () {
                    ...
                    if (t.isEmptyObject(o)) n.off("keyup.autocomplete focus.autocomplete");
                        ...
                        n.off("blur.autocomplete").on("blur.autocomplete", function () {
                            ...
                            13 === i && r >= 0 ? (e = c.children("li").eq(r)).length && (e.trigger("mousedown.autocomplete"), t.preventDefault()) : 38 !== i && 40 !== i || (t.preventDefault(), 38 === i && r > 0 && r--, 40 === i && r < n - 1 && r++, o.removeClass("active"), r >= 0 && c.children("li").eq(r).addClass(""))
                ...
                return e = t.extend(i, e), this.each(function () {
                    ...
                    function n(t) {
                        t >= c.length ? t = 0 : t < 0 && (t = c.length - 1), (u = l.find(".active").index()) != t && (o = c.eq(u), $caption = o.find(".caption"), o.removeClass("active"), o.velocity({
                            ...
                            queue: !1,
                            easing: "easeOutQuad"
                        }), c.eq(t).addClass(""), e.indicators && a.eq(t).addClass(""))
                    }
                    var o, a, r, s = t(this),
                    ...
                    }), s.append(a), a = s.find("ul.indicators").find("li.indicator-item")), o ? o.show() : (c.first().addClass("").velocity({
                        opacity: 1
                    }, {
                        duration: e.transition,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), u = 0, o = c.eq(u), e.indicators && a.eq(u).addClass("")), o.find("img").each(function () {
        ...
        t(document).ready(function () {
            ...
            n.hasAutocomplete = !t.isEmptyObject(o.autocompleteOptions.data), this.init = function () {
                ...
                n.$document.off("click.chips-focus", e.CHIPS).on("click.chips-focus", e.CHIPS, function (i) {
                    ...
                    n.addClass("focus"), n.siblings("label, .prefix").addClass(""), t(e.CHIP).removeClass("selected")
                ...
                var a = e.next("label");
                a.length && (a.attr("for", i), void 0 !== e.data("chips") && e.data("chips").length && a.addClass(""));
                var r = t("#" + i);
    ...
    function (t) {
        ...
        var e = function (e) {
                ...
                if (!1 === i.hasClass("active")) {
                    var n, o;
                    !0 === i.hasClass("horizontal") ? o = 40 : n = 40, i.addClass(""), i.find("ul .btn-floating").velocity({
                        scaleY: ".4",
                        scaleX: ".4",
                        translateY: n + "px",
                        translateX: o + "px"
            ...
            n = function (e) {
                if ("true" !== e.attr("data-open")) {
                    ...
                    c.append(d), i = l.left - r / 2 + l.width / 2, n = s - l.bottom, a = r / d.width(), e.attr("data-origin-bottom", l.bottom), e.attr("data-origin-left", l.left), e.attr("data-origin-width", l.width), e.addClass(""), e.attr("data-open", !0), e.css({
                        "text-align": "center",
                        width: "100%",
                        bottom: 0,
                        left: 0,
    ...
    function (t) {
        ...
        o.DEFAULTS = {
            ...
            a(this.options.beforeDone), this.hide(), this.label.addClass("");
                ...
                return this.each(function (i) {
                    ...
                    j.addClass("initialized"), k = !1, b = A = 0, v = [], m = j.find(".carousel-item").first().innerWidth(), g = j.find(".carousel-item").first().innerHeight(), x = 2 * m + e.padding, j.find(".carousel-item").each(function (e) {
                        if (v.push(t(this)[0]), N) {
                            ...
                            0 === e && i.addClass(""), i.click(function (e) {
